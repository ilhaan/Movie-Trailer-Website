...
# Instances of the class 'Movie()' are created below for the seven movies
...
furious_7 = media.Movie("Furious 7",
                        ...
                        "http://t1.gstatic.com/images?q=tbn:ANd9GcReedjA2vJSO4_6GDpsI3PShvbRqfAAEv03qaJ9qOxtiLZX0Jx7",  # noqa
                        "https://www.youtube.com/watch?v=yISKeT6sDOg",
                        "2015")

spiderman = media.Movie("Spider-Man",
                        "When bitten by a genetically modified spider, a \
                        nerdy, shy, and awkward high school student gains \
                        spider-like abilities that heeventually must use to \
                        fight evil as a superhero after tragedy befalls his \
                        family.",
                        "https://upload.wikimedia.org/wikipedia/en/f/f3/Spider-Man2002Poster.jpg",  # noqa
                        "https://www.youtube.com/watch?v=O7zvehDxttM",
                        "2002")

primal_fear = media.Movie("Primal Fear",
                          "An altar boy is accused of murdering a priest, and \
                          the truth is buried several layers deep.",
                          "https://upload.wikimedia.org/wikipedia/en/f/f7/Primal_Fear.jpg",  # noqa
...
rush_hour = media.Movie("Rush Hour",
                        ...
                        "https://upload.wikimedia.org/wikipedia/en/5/55/Rush_hour_ver2.jpg",  # noqa
                        "https://www.youtube.com/watch?v=JMiFsFQcFLE",
                        "1998")

terminator = media.Movie("The Terminator",
                         "A human-looking indestructible cyborg is sent from \
                         2029 to 1984 to assassinate a waitress, whose unborn \
                         son will lead humanity in a waragainst the machines, \
                         while a soldier from that war is sent to protect her \
                         at all costs.",
...
movies = [dark_knight, furious_7, spiderman, primal_fear, rush_hour,
          terminator, iron_man]
